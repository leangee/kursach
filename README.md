...
# Описание
Веб-приложение для автоматизации работы детейлинг-студии. Клиенты могут записываться на услуги, отслеживать статус заказа в реальном времени через WebSocket, добавлять работы в избранное. Мастера и администраторы управляют заказами и портфолио.
